...
const arrowGreetingExplicit = (name) => {return `Hi ${name}`}

// Arrow function, implicit return
const arrowGreetingImplicit = name => {return `Hi ${name}`}
const arrowGreetingImplicitMultipleParam = (name, lastName) => {return `Hi ${name} ${lastName}`}
...
fictionalCharacter.traditionalMessage("With great power comes great responsability");
